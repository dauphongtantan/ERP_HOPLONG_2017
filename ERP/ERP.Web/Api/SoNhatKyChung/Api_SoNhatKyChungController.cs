    ...
    public class Api_SoNhatKyChungController : ApiController
    {
        ...
        public IHttpActionResult PostKT_SO_NHAT_KY_CHUNG(DonBanHang kT_SO_NHAT_KY_CHUNG)
        {
            ...
            foreach (var item in kT_SO_NHAT_KY_CHUNG.ChiTietBH)
            {
                ...
                chitiet1.NGAY_HACH_TOAN = DateTime.Today.Date;
                chitiet1.NGAY_CHUNG_TU = DateTime.Today.Date;
                ...
                chitiet2.NGAY_HACH_TOAN = DateTime.Today.Date;
                chitiet2.NGAY_CHUNG_TU = DateTime.Today.Date;
                ...
                if (item.TK_THUE != null)
                {
                    ...
                    chitiet3.NGAY_HACH_TOAN = DateTime.Today.Date;
                    chitiet3.NGAY_CHUNG_TU = DateTime.Today.Date;
                    ...
                    chitiet4.NGAY_HACH_TOAN = DateTime.Today.Date;
                    chitiet4.NGAY_CHUNG_TU = DateTime.Today.Date;
