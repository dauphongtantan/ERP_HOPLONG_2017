...
namespace ERP.Web.Api.MuaHang
{
    public class Api_HangCanDatController : ApiController
    {
        ...
        public IHttpActionResult ThemHangCanDat(MH_HANG_CAN_DAT hangcandat)
        {
            ...
            KHO_HANG_CAN_GIU hangcangiu = new KHO_HANG_CAN_GIU();
            hangcangiu.ID_PO_BAN = hangcandat.ID_CT_PO;
            hangcangiu.MA_HANG = hangcandat.MA_HANG;
            hangcangiu.SL_CAN_GIU = hangcandat.SL_DAT;
            db.KHO_HANG_CAN_GIU.Add(hangcangiu);
            db.SaveChanges();
